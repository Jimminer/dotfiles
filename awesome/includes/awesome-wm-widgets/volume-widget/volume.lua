...
local function GET_VOLUME_CMD(device) return 'amixer -M sget Master' end
local function INC_VOLUME_CMD(device, step) return 'amixer -M sset Master ' .. step .. '%+' end
local function DEC_VOLUME_CMD(device, step) return 'amixer -M sset Master ' .. step .. '%-' end
local function TOG_VOLUME_CMD(device) return 'amixer -M sset Master toggle' end
...
local function worker(user_args)
    ...
    local mixer_cmd = args.mixer_cmd or 'pavucontrol -t 3'
