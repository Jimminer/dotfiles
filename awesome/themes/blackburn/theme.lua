...
theme.bg_minimize                               = "#392747"
theme.fg_urgent                                 = "#FFFFFF"
theme.bg_urgent                                 = "#641ac4"
theme.border_width                              = dpi(0)
theme.border_normal                             = "#000000"
theme.border_focus                              = "#9245ff"
theme.taglist_fg_focus                          = "#9245ff"
theme.taglist_bg_focus                          = "#060606"
theme.tasklist_fg_focus                         = "#FFFFFF"
theme.tasklist_bg_focus                         = "#6831b5"
...
theme.weather = lain.widget.weather({
    --APPID =
    city_id = 734077, -- placeholder (London)
    settings = function()
